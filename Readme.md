...
### 🏪 [Cloud CRM](https://github.com/Bolohonov/crm) + [E-commerce Platform](https://github.com/Bolohonov/shop-project)
...
### 🎬 [Video Insights Service](https://github.com/Bolohonov/video-insights)

AI-сервис анализа видео: загружает видео, нарезает на кадры через Go + ffmpeg, отправляет в Vision API (Claude / Gemini) и строит тайм-лайн событий с описанием каждого момента. Прогресс обработки стримится в браузер через SSE.

`Java 21` `Spring Boot 3` `Go` `Vue 3` `Kafka` `PostgreSQL` `MinIO` `Docker` `k3s`
